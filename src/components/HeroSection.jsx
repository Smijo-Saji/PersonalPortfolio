  ...
  return (
    <div className="flex  flex-wrap items-center min-h-[700px] mt-10 lg:mt-0">
      ...
      <div className="w-full lg:w-1/2">
        <h4 className="text-3xl text-center lg:text-start mb-3 text-neutral-500 mt-10 lg:mt-1">
          Hello I'm
        </h4>
        <h1 className="text-4xl sm:text-6xl lg:text-7xl tracking-wide mt-1  lg:mt-1 lg:text-start text-center">
