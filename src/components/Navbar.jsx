        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            <img
              ...
              src="https://i.postimg.cc/vTMDTDLs/abstract-initial-letter-s-ss-logo-orange-color-isolated-white-background-388320-1088-removebg-previe.png"
              alt="logo"
            />
            <span className="text-2xl tracking-tight font-semibold">
              Smijo <span className="text-orange-400">_</span>
            </span>
          </div>
